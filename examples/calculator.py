...
return "Cannot divide by zero";
        empty;
        comment create numbers
        create 1;
        create 2;
        create 3;
        create 4;
        systemOutPrint("Select operation:");
        systemOutPrint("1. Add");
        systemOutPrint("2. Subtract");
        systemOutPrint("3. Multiply");
        systemOutPrint("4. Divide");
        empty;
        ...
        empty;
        if choice == 1:
    systemOutPrint(num1, "+", num2, "=", add(num1, num2));
        elif choice == 2:
    systemOutPrint(num1, "-", num2, "=", subtract(num1, num2));
        elif choice == 3:
    systemOutPrint(num1, "*", num2, "=", multiply(num1, num2));
        elif choice == 4:
    systemOutPrint(num1, "/", num2, "=", divide(num1, num2));
        else:
    systemOutPrint("Invalid input");
        empty;
        end;
'''